...
class Test_AES(unittest.TestCase):
    ...
    def test_MAC3(self):
        ...
        value = MAC3("8482000010B1AF3A86C447E3C8800000", "9A2D5FBF78BD2ACC66BDC3FC62935476", "0000000000000000")
        #self.assertEqual(value, "A6DC02F7058ADA54")
        
        
        
        value = MAC3("02003F08A00000007707020109A0000000010101010114738F8ADBF0E7F2DBC762FB799495A5D3284B377916EF00B612420660616263646545081434128014341280800000000000", "01020304050607080102030405060708", "0000000000000000")
